...
#' @param dep Initial depletion
#' @param h Beverton-Holt tock-recruitment steepness
#' @param M Natural mortality
#' @param selpars Selectivity parameters
#' @param epsr
#' @param dms Dimensions: ages, seasons, fleets, selectivities
#' @param pctarg
#' @param selidx Selectivity to assign to each fleet
#' @examples
...
mcmc3.abc <- function(nits) {
  ...
  xx <- sim(R0=R0, dep=dep, h=hold, M=Mold, selpars=selpars, epsr=epsr,
    dms=dms, pctarg=pctarg, selidx=selidx)
