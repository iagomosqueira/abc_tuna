 ...
 */
//[[Rcpp::export]]
RcppExport SEXP projdd(SEXP Ninit_,SEXP B0_,SEXP hh_,SEXP SPR_,SEXP sigmar_,SEXP rho_,SEXP M_,SEXP wt_,SEXP mat_,SEXP sel_,SEXP fshare_,SEXP xifix_,SEXP dm_)
{
  ...
  for(y=1;y<ny;y++) {
    ...
    for(a=1;a<na;a++) {
      ...
      for(xisum=0.,f=0;f<nf;f++) xisum += xi(a-1,f);
    ...
    for(xisum=0.,f=0;f<nf;f++) xisum += xi(na-1,f); 
